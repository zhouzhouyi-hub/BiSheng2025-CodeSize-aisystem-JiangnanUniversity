...
public:
  ...
  std::map<uint64_t, std::pair<SegmentInfo, uint64_t>> SegmentMapInfoWithGap;
  ...
  static constexpr unsigned HugePageSize = 0x1000;  // YANGZI20250404 一定要改页大小!否则PHDR非常大!
  ...
  // YANGZI20250323
  bool isRISCV32() const { return TheTriple->getArch() == llvm::Triple::riscv32; }
