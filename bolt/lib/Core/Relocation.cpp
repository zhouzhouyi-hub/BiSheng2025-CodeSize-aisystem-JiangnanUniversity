...
static size_t getSizeForTypeRISCV(uint64_t Type) {
  ...
  case ELF::R_RISCV_ADD32:
  case ELF::R_RISCV_SUB32:
  case ELF::R_RISCV_HI20:        // YANGZI20250407 通常是 lui
  case ELF::R_RISCV_LO12_I:      // YANGZI20250407 通常是 addi/lw 等 I 格式
  case ELF::R_RISCV_LO12_S:      // YANGZI20250407 通常是 sw 等 S 格式
  case ELF::R_RISCV_32:          // YANGZI20250407 data/rodata重定位
    return 4;
  case ELF::R_RISCV_64:
  case ELF::R_RISCV_GOT_HI20:
  case ELF::R_RISCV_TLS_GOT_HI20:
...
static uint64_t extractValueRISCV(uint64_t Type, uint64_t Contents,
  ...
  default:
    errs() << object::getELFRelocationTypeName(ELF::EM_RISCV, Type) << '\n';
    llvm_unreachable("unsupported relocation type");
  case ELF::R_RISCV_32:    // YANGZI20250407
  case ELF::R_RISCV_64:
  case ELF::R_RISCV_ADD32:
  case ELF::R_RISCV_SUB32:
    return Contents;
  ...
  case ELF::R_RISCV_HI20:   // YANGZI20250407
    return extractUImmRISCV(Contents);
  case ELF::R_RISCV_LO12_I: // YANGZI20250407
    return extractIImmRISCV(Contents);
  case ELF::R_RISCV_LO12_S: // YANGZI20250407
  case ELF::R_RISCV_PCREL_LO12_S:
...
static bool isPCRelativeRISCV(uint64_t Type) {
  ...
  case ELF::R_RISCV_HI20:        // YANGZI20250407
  case ELF::R_RISCV_32:          // YANGZI20250407
  case ELF::R_RISCV_64:          // YANGZI20250422
  case ELF::R_RISCV_COPY:        // YANGZI20250422
    return false;
  case ELF::R_RISCV_JAL:
  case ELF::R_RISCV_CALL:
  case ELF::R_RISCV_CALL_PLT:
...
bool Relocation::isSupported(uint64_t Type) {
  ...
  if (Arch == Triple::riscv64 || Arch == Triple::riscv32)               // YANGZI20250323
...
MCBinaryExpr::Opcode Relocation::getComposeOpcodeFor(uint64_t Type) {
  assert((Arch == Triple::riscv64 || Arch == Triple::riscv32) && "only implemented for RISC-V");
...
#include "llvm/BinaryFormat/ELFRelocs/AArch64.def"
  ...
  else if (Arch == Triple::riscv64 || Arch == Triple::riscv32) {               // YANGZI20250323
